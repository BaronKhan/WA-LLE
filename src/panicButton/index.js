...
const readfall = require('readline');
const rl = readfall.createInterface({
  input: process.stdin
});
...
console.log('waiting for dash button to be pressed/fall signal received...');
...
//Receive message from fall detection 

rl.question('Detected fall?', function(signal) {
  if(signal == '2'){
